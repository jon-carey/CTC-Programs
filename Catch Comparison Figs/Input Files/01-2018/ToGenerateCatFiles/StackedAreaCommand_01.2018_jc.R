...
#     this_is_the_place <- "C:\\data\\Temp\\CTC"
 ...
 #observed, model-lc, model-totmort
  catchtype = "model-lc"
   #input files that YOU provide
  Dir <- "C:\\data\\GitHub\\CTC-Programs\\Catch Comparison Figs\\Input Files\\01-2018\\ToGenerateCatFiles\\"
  
  Paths = list(paste(Dir, "BPCV1-21\\bpP2auxCatch.csv", sep = ""),
               paste(Dir, "BPCV1-21\\bpP2fisherymap.txt", sep = ""),
               paste(Dir, "BPCV1-21\\bpP2stockmap.txt", sep = ""),
               paste(Dir, "BPCV1-21\\bpP22017P_fish_AABM_CCC.csv", sep = ""),
               paste(Dir, "BPCV1-21\\bpP22017P_fish_ISBM_CCC.csv", sep = ""),
               paste(Dir, "BPCV1-21\\obsCatch.csv", sep = ""),
               paste(Dir, "BPCV1-21\\fisheryCodes.csv", sep = ""),
               paste(Dir, "BPCV1-21\\stockCodes.csv", sep = ""))
